...
app.get("/webhook", function (req, res) {
  ...
  // if (req.query["hub.verify_token"] === functions.config().token.verification) {
...
function callSendAPI(messageData) {
  request({
    ...
    qs: { access_token: 'EAAX8CBYjqLEBAAtBiOl1cdtczWIT8v6NG26B7uKifgEkjNt3KVQBWMUGUWlEjPnZCfBgAH9rOUHfIyzx3W6O826I28KgL20ePEDJstqHkzIwHiFwmjjWmDwHfEPNTFj1WNlNWiXZCI4aywRZAJI0yqjEIUgGCVHMxeb21hMArumIxOiqyv4' },
    method: 'POST',
    json: messageData
